...
class CIFAR10Dataset(ClassificationDataset):
    ...
    def load_cifar(self):
        ...
        for f in files:
            ...
            img_data = np.reshape(img_data,(img_data.shape[0],32,32,3),order = "F")
    ...
    def __getitem__(self, idx: int) -> Tuple:
        ...
        label = self.classes[self.data[1][idx]]
        
        image = Image.fromarray(image, mode='RGB') #needs to be done otherwise transform does not apply directly on numpy arrays      
