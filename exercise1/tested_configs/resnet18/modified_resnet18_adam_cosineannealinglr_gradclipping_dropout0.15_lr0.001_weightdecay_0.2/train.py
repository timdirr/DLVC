...
CONFIG_NAME = "modified_resnet18_adam_cosineannealinglr_gradclipping_dropout0.15_lr0.001_weightdecay_0.2"
...
def train(args):
    ...
    model.net.fc.register_forward_hook(lambda m, inp, out: F.dropout(out, p=0.15, training=m.training))

    optimizer = torch.optim.AdamW(model.parameters(), lr=args.lr, amsgrad=True, weight_decay=0.2)
