...
CONFIG_NAME = "dropout_30_aug_hflip_crop_kaggle_ref_100_epoch_lr_0_002"
...
def train(args):
    ...
    model.net.fc.register_forward_hook(lambda m, inp, out: F.dropout(out, p=0.3, training=m.training))
