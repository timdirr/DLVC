...
def train(args):
    ...
    model.to(device)
    optimizer = torch.optim.AdamW(model.parameters(), lr=0.001, amsgrad=True,weight_decay=0.1) # AdamW has standard weight decay of 0.01
